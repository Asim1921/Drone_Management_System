# PowerShell script to deploy DMS to VPS
$serverIP = "72.60.211.71"
$username = "root"
$password = "Akinator786"
...
Write-Host "Copying deployment script to server..."
# Use plink or ssh with password
# Note: This requires plink.exe from PuTTY or using SSH keys
# For now, we'll provide instructions

Write-Host ""
Write-Host "=========================================="
Write-Host "To deploy, run this command in your terminal:"
Write-Host "=========================================="
Write-Host ""
Write-Host "ssh root@72.60.211.71 'bash -s' < $tempScript"
Write-Host ""
Write-Host "Or copy the script to server and run:"
Write-Host "scp $tempScript root@72.60.211.71:/tmp/deploy.sh"
Write-Host "ssh root@72.60.211.71 'bash /tmp/deploy.sh'"
Write-Host ""
